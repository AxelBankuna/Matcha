...
if (login_check_new($db) == true) :
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="row" style="margin-bottom: 50px">
                ...
                <div class="col-sm-9" style="background-color:gainsboro; padding: 20px">
                    ...
                    include_once 'includes'.$DS.'search_results.inc.php';
        ...
        <script>
            setInterval(function msg_update() {
                msg_count = <?php echo $msg_count; ?>;
                contact_id = <?php echo $c; ?>;
                if (msg_count == 0){
                    ...
                    xmlhttp.onreadystatechange = function () {
                        if (this.responseText > msg_count){
                            document.getElementById("new_msg").innerHTML = "You have mail";
                        }
                    }
